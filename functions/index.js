...
exports.sendAdviceEmail = onRequest((req, res) => {
    corsHandler(req, res, async () => {
        try {
            ...
            // ✅ OpenAI へプロンプト送信
            const prompt = `あなたは熟練の易者であり、相談者に易経を用いて誠実で深い助言を与えるAIです。以下の情報をもとに、相談者 ${userName} さんに対して、日本語で約5,000字のエッセイ方式のアドバイスを作成してください。形式的な箇条書きではなく、論理的かつ有機的に流れる文章にしてください。
            【事前の総合的な易断】（相談者の状態を示す既知情報）：
${summaryText}

【1. 重視する構成比と観点】
- 本卦と変爻の解釈を全体の7割に充て、現在の状況とその変化の兆しに焦点を当ててください。
- 残りの3割で、変卦・裏卦・総卦・互卦を必要に応じて補完的に解釈してください。
  - 裏卦：未来の兆し、得卦の補完的意味
